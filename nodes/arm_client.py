...
def call_server():
    ...
    client5 = actionlib.SimpleActionClient('wipe_as', robot_geoAction)
    ...
    #GOAL MOVE
    goal.move = True #Specify if MOVE if required
    ...
    #Wait for primitives (grasp, release, screw) to be executed
    time.sleep(15)
    '''
